...
const flight_controller_js_1 = require("./flight.controller.js");
...
FlightModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [flight_service_ts_1.FlightService],
        controllers: [flight_controller_js_1.FlightController],
    })
], FlightModule);
